...
internal sealed class OtlpLocalLogExportClient : BaseOtlpLocalExportClient<OtlpCollector.ExportLogsServiceRequest>
{
    private readonly OtlpCollector.LogsService.LogsServiceClient logsClient;

    public OtlpLocalLogExportClient(OtlpExporterOptions options, OtlpCollector.LogsService.LogsServiceClient logsServiceClient = null)
        : base(options)
    {
