...
internal sealed class OtlpLocalMetricsExportClient : BaseOtlpLocalExportClient<OtlpCollector.ExportMetricsServiceRequest>
{
    private readonly OtlpCollector.MetricsService.MetricsServiceClient metricsClient;

    public OtlpLocalMetricsExportClient(OtlpLocalExporterOptions options, OtlpCollector.MetricsService.MetricsServiceClient metricsServiceClient = null)
        : base(options)
    {
