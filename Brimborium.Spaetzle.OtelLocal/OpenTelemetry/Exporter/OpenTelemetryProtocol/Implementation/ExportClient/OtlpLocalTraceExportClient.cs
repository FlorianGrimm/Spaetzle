...
internal sealed class OtlpLocalTraceExportClient : BaseOtlpLocalExportClient<OtlpCollector.ExportTraceServiceRequest>
{
    private readonly OtlpCollector.TraceService.TraceServiceClient traceClient;

    public OtlpLocalTraceExportClient(OtlpLocalExporterOptions options, OtlpCollector.TraceService.TraceServiceClient traceServiceClient = null)
        : base(options)
    {
